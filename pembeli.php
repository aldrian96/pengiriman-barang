...
$pembelis = $stmt->fetchAll(PDO::FETCH_ASSOC);
?>
<!DOCTYPE html>
        ...
        <div class="main">
            ...
            <main class="content px-3 py-2">
                <div class="container-fluid">
                    <div class="mb-3">
                        <h4>Data Pembeli</h4>
                        <a href="tambah/tambah_pembeli.php" class="btn btn-primary"><i class="fa fa-plus" aria-hidden="true"></i> Tambah Pembeli</a>
                    </div>
                    <!-- Table Element -->
                    <div class="card border-0">
                        <div class="card-header">
                            <h5 class="card-title">Table Pembeli</h5>
                        ...
                        <div class="card-body">
                            <table class="table ">
                                ...
                                <tbody>
                                    <?php foreach ($pembelis as $index => $pembeli) : ?>
                                        <tr>
                                            <td><?= $index + 1 ?></td>
                                            <td><?= $pembeli['nama_pembeli'] ?></td>
                                            <td><?= $pembeli['alamat'] ?></td>
                                            <td>
                                                <a href="ubah/ubah_pembeli.php" class="btn btn-warning btn-sm"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit</a>
