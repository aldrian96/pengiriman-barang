        ...
        <div class="main">
            ...
            <main class="content px-3 py-2">
                <div class="container-fluid">
                    <div class="mb-3">
                        <h4>Data Barang</h4>
                        <a href="tambah/tambah_barang.php" class="btn btn-primary"><i class="fa fa-plus" aria-hidden="true"></i> Tambah Barang</a>
                    </div>
                    <!-- Table Element -->
                                ...
                                <tbody>
                                    <?php foreach ($barangs as $index => $barang) : ?>
                                        <tr>
                                            ...
                                            <td><?= $barang['harga'] ?></td>
                                            <td>
                                                <a href="ubah/ubah_barang.php" class="btn btn-warning btn-sm"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit</a>
