                ...
                <div class="container mt-4">
                    ...
                    <form>
                        <div class="form-group mb-3">
                            ...
                            <input type="text" class="form-control" id="namaBarang" placeholder="Masukkan nama pengirim" />
                        </div>
                        <div class="form-group mb-3">
                            <label for="hargaBarang">Harga Barang</label>
                            <input type="text" class="form-control" id="hargaBarang" placeholder="Masukkan nama penerima" />
                        </div>
